    ...
    public class LightCamera : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if(this.targetCamera == null)
            {
                ...
                beam.gbuffer = go.GetComponent<CameraRender>();
            }
            this.targetCamera.cullingMask = 1 << LayerMask.NameToLayer("Generator");
        ...
        {
            return this.targetLight.type == LightType.Directional;
        }
        public Vector3 Direction()
        {
            return this.targetLight.gameObject.transform.forward;
        }
